...
while True:
    ...
    while True:
        ...
        intento = input("introduce un numero de 4 digitos o la q para salir")
        ...
        elif intento[0] not in digitos or intento[1] not in digitos or intento[2] not in digitos or intento[3] not in digitos:
